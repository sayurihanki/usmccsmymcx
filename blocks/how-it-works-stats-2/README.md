# How It Works + Stats 2 Block

## Overview

The `how-it-works-stats-2` block renders a 4-step process section, a 4-metric
stats band, and two CTA buttons underneath.

## DA.live Authoring Model

Author with a one-column table named `how-it-works-stats-2` and 12 rows.
